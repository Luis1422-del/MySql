...
public class MainActivity extends AppCompatActivity {
        ...
        btn_guardar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(et_descripcion.getText().toString().length()==0){
                    et_descripcion.setError("Campos obligatorio");
                    inputEd = false;
                }else {
                    inputEd=true;
                }
    ...
    private void DialogConfirmacion2(){
        ...
        dialogo.setNegativeButton("Volver", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialogo, int id) {
                Toast.makeText(getApplicationContext(), "github.com/william05913", Toast.LENGTH_LONG).show();
            }
        });
        dialogo.show();
    }
